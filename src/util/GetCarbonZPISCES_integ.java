...
public class GetCarbonZPISCES_integ {
...
///////////////////////////////
 ...
 /**
     ...
     */
    static float[][] CarbZ_tp0;
    /**
     * /**
     * ... at time t + dt
     */
    static float[][] CarbZ_tp1;
    /**
...
////////////////////////////
    ...
    public static void setUp() throws IOException {
        ...
        strTimeDim = "TIME";
        strCarbonZ = "CARBONZ_TOT_Z_INTEG";
        strXiDim = "XI_RHO";
        strEtaDim = "ETA_RHO";

        String fileName = get_filename(Dataset_EVOL.yearlist100[1]);
        open(fileName);
...
//        readConstantField();
    ...
    static String get_filename(int year) {
       ...
       String fileName = Dataset_EVOL.directory_Suplementary_data + Dataset_EVOL.region + "_CarbonZTOT_integ50m_Y" + year + ".nc";
        return fileName;
    }
            // rc23 : "CarbonZ_TOT_z_integ50m_rc23_Y
...
//        nbTimeRecords = ncIn.findDimension(strTimeDim).getLength();
    ...
    static void setAllFieldsTp1AtTime(int rank) throws IOException {
        ...
        try {
            ...
            CarbZ_tp1 = (float[][]) ncIn.findVariable(strCarbonZ).read(
                    new int[]{rank, 0, 0},
                    new int[]{1, ny, nx}).reduce().copyToNDJavaArray();

    //System.out.println("CarbZ_tp1[138][185] = " + CarbZ_tp1[185][138]);
...
// Timothee...
    public static void loadCarbonZ_PISCES_integ(int jour, int year) throws IOException {
        ...
        int pas_de_temps_5jour = (int) Math.floor(jour / 5);
        if (jour == 360) {
            jourdumois = 30;
            month = 12;
...
//        System.out.println("pas_de_temps_5jour " + pas_de_temps_5jour );

        

        int rank = pas_de_temps_5jour; // Depuis le 23 oct 2010 (avant : month-1);
        // 1) COPIER LES DONNÉE PRécédantes "Tp1" dans "Tp0"
        //setAllFieldsAtTime();
        setAllFieldsTp1AtTime(rank);
    }

public static double getCarbonZ_PISCES_integ(double xRho, double yRho) throws
...
public static double getCarbonZ_PISCES_integ(int i, int j) throws
            ArrayIndexOutOfBoundsException {
        double chla;
        chla = CarbZ_tp1[j][i];
        return chla;
